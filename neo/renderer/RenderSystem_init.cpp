...
idCVar r_shadowMapSamples( "r_shadowMapSamples", "4", CVAR_RENDERER | CVAR_INTEGER, "1, 4, 12 or 16", 1, 64 );
...
void R_SetNewMode( const bool fullInit )
{
	...
	for( int i = 0 ; i < 3 ; i++ )
	{
		if( i == 0 && stereoRender_enable.GetInteger() != STEREO3D_OFF )
		{
...
#pragma warning( pop )
		...
		// TODO remove because we killed quad stereo support
		parms.stereo = false;
